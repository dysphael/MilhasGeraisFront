...
export const mockAnalyticsData = {
  programas: [
    ...
    { name: 'TudoAzul', miles: 15000, fill: '#3B82F6' },
    { name: 'Esfera',   miles:  8000, fill: '#8B5CF6' },
  ],
  distribuicao: [
    { name: 'Livelo',    miles: 40000, color: '#748944' },
    { name: 'Smiles',    miles: 25000, color: '#054A91' },
    { name: 'LATAM Pass',miles: 18000, color: '#6EA4BF' },
    { name: 'TudoAzul',  miles: 15000, color: '#3B82F6' },
    { name: 'Esfera',    miles:  8000, color: '#8B5CF6' },
  ],
  evolucao: [
...
// Cotações mockadas dos scrapers (Smiles, LATAM, Livelo, TudoAzul)
export const mockMilesQuotes: MilesQuote[] = [
  {
    program: 'Smiles',
  ...
  {
    program: 'Latam Pass',
    sourceUrl: 'https://www.latampass.latam.com/pt_br/compre-pontos',
    pricePerMile: 0.031,
    bonusMultiplier: 1.5,
    promotionDescription: '50% de bônus em pontos este fim de semana!',
    scrapedAt: new Date().toISOString(),
    isPromotion: true,
  },
  {
    program: 'Livelo',
    sourceUrl: 'https://www.livelo.com.br/compre-pontos',
    pricePerMile: 0.028,
    bonusMultiplier: null,
    promotionDescription: null,
    scrapedAt: new Date().toISOString(),
  ...
  },
  {
    ...
    pricePerMile: 0.027,
    bonusMultiplier: 2.0,
    promotionDescription: '100% de bônus em pontos TudoAzul!',
    scrapedAt: new Date().toISOString(),
    isPromotion: true,
  },
];
